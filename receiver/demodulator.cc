...
DemodulatorCtrl::DemodulatorCtrl(Receiver *receiver) :
  gui::Spectrum(DEFAULT_FFT_RATE, DEFAULT_FFT_SIZE, receiver), _receiver(receiver), _demodObj(nullptr), _config()
{
...
void
DemodulatorCtrl::setFilterWidth(double w, bool sendEmit) {
...
DemodulatorCtrl::setDemod(Demod demod) {
  ...
  if (_demodObj) {
    ...
    delete _demodObj; _demodObj = nullptr;
  }
