...
/** Interface of a spectrum provider. */
...
public:
   ...
   * @param parent Specifies the parent of the @c Spectrum instance. */
    explicit Spectrum(double rrate=2, size_t fftsize=1024, QObject *parent = nullptr);
